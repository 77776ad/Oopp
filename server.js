...
setInterval(() => {
  http.get(`http://haider-mu.glitch.me/`);
}, 280000);
...
const youtube = new YouTube('AIzaSyBfdyAnjM55sLhQwW6SzZM_usE502bwsJE');
const hastebins = require('hastebin-gen');
const getYoutubeID = require('get-youtube-id');
const yt_api_key = "AIzaSyBfdyAnjM55sLhQwW6SzZM_usE502bwsJE";
...
let g = client.guilds.get("704477475270557696"); // id server
let c = g.channels.get("704477477300469776");// id channel
if(c.type === 'voice') {
c.join();
setInterval(() => {
